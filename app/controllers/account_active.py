            ...
            jsonify(
                {
                    ...
                    "user": {
                        ...
                        "last_name": account_active_data.account_active.user.last_name,
                        "first_name": account_active_data.account_active.user.first_name,
                        "company_name": account_active_data.account_active.user.company_name,
